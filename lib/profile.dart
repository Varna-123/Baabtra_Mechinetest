                      ...
                      child: Column(
                        children: [
                          CircleAvatar(
                                          ...
                                          Text('UI/UX',style: TextStyle(color:Colors.red),),
                                          ListTile(
                                    ...
                                    ListTile(
                                      ...
                                      title: Text('Friends',),
                                      trailing: Icon(Icons.nine_mp_outlined,color: Colors.green,),
                                    ),
                                    ListTile(
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: IconButton(onPressed:(){}, icon:const Icon(Icons.arrow_circle_up_outlined,size: 45,),color: Colors.red,),
                                    ),
